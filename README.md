...
I love my V0.1 very much. With my current setup, the stock part cooling is the limiting factor, and was preventing me from printing PLA/PETG/ABS just a *little* faster. I was originally inspired by Vez3D (https://www.youtube.com/watch?v=E3kBau82SwU) and his cooling setup, and my design was built off of KurioHonoo's wonderful Mini AfterSherpa (https://github.com/KurioHonoo/Mini-AfterSherpa/blob/main/README.md), in which i have replaced the area for the 3010 fans with an internal ducting system, which directs air from a 7040 brushless blower fan. 
